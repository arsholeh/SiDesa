            ...
            @if (count($complaints) < 1)
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $item->title }}</td>
                  <td>{!! wordwrap($item->content, 40, "<br>\n") !!}</td>
                  ...
                  <td>
                    <div class="d-flex align-items-center" style="gap:10px;">
                      <a href="/complaint/{{ $item->id }}" class="btn btn-sm btn-warning d-inline-block">
                      <i class="fas fa-pen"></i>
                      </a>
                      <button href="/complaint/{{ $item->id }}" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#ConfirmationDelete-{{ $item->id }}">
